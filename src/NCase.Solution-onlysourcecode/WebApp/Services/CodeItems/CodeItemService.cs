  ...
  public class CodeItemService : Service<CodeItem>, ICodeItemService
  {
    ...
    public async Task UpdateJavascriptAsync(string filename)
    {
          ...
          )
      {
        ...
        sw.WriteLine($"        var filtername = item.CodeType.ToLower() + "filtersource";
        ...
        sw.WriteLine($"        sw.WriteLine($"function {item.CodeType.ToLower()}formatter(value, row, index) {{ ");
        ...
        sw.WriteLine($"        sw.WriteLine($"$.extend($.fn.datagrid.defaults.filters, {{");
        ...
        sw.WriteLine($"        sw.WriteLine($"$.extend($.fn.datagrid.defaults.editors, {{");
