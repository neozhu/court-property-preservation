...
{
/// <summary>
/// File: NodeTimeQuery.cs
/// Purpose: easyui datagrid filter query 
/// Created Date: 3/19/2020 4:51:03 PM
/// Author: neo.zhu
/// Tools: SmartCode MVC5 Scaffolder for Visual Studio 2017
/// Copyright (c) 2012-2018 All Rights Reserved
/// </summary>
   public class NodeTimeQuery:QueryObject<NodeTime>
   {
		public NodeTimeQuery Withfilter(IEnumerable<filterRule> filters)
        {
           if (filters != null)
           {
