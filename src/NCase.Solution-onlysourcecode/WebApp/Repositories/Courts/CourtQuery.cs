...
/// Created Date: 3/3/2020 10:49:50 AM
/// Author: neo.zhu
/// Tools: SmartCode MVC5 Scaffolder for Visual Studio 2017
/// Copyright (c) 2012-2018 All Rights Reserved
/// </summary>
   public class CourtQuery:QueryObject<Court>
   {
		public CourtQuery Withfilter(IEnumerable<filterRule> filters)
        {
           if (filters != null)
           {
         ...
         public  CourtQuery ByCompanyIdWithfilter(int companyid, IEnumerable<filterRule> filters)
         {
