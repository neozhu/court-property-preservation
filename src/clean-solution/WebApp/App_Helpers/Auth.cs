...
namespace WebApp
{
  public static class Auth
  {
    ...
    public static string GetCompanyCode(string username = "") => cache.GetOrAdd("Identity.Name", () =>
    {
    ...
    public static string GetFullName(string username = "") => cache.GetOrAdd($"Identity.Id.{username}", () =>
    {
      username = string.IsNullOrEmpty(username) ? HttpContext.Current.User.Identity.Name : username;
      var db = SqlHelper2.DatabaseFactory.CreateDatabase();
    ...
    public static int GetTenantIdByName(string username = "") => cache.GetOrAdd($"Identity.TenantId.{username}", () =>
    {
      username = string.IsNullOrEmpty(username) ? HttpContext.Current.User.Identity.Name : username;
      var db = SqlHelper2.DatabaseFactory.CreateDatabase();
    ...
    public static string GetUserIdByName(string username = "") => cache.GetOrAdd($"Identity.Id.{username}", () =>
    {
      username = string.IsNullOrEmpty(username) ? HttpContext.Current.User.Identity.Name : username;
      var db = SqlHelper2.DatabaseFactory.CreateDatabase();
    ...
    public static string GetAvatarsByName(string username = "", int size = 50) => cache.GetOrAdd($"Identity.Avatar.{username}", () =>
    {
      username = string.IsNullOrEmpty(username) ? HttpContext.Current.User.Identity.Name : username;
      var db = SqlHelper2.DatabaseFactory.CreateDatabase();
      var photopath = "";
