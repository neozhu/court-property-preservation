...
/// Created Date: 3/4/2020 12:00:42 PM
/// Author: neo.zhu
/// Tools: SmartCode MVC5 Scaffolder for Visual Studio 2017
/// Copyright (c) 2012-2018 All Rights Reserved
/// </summary>
    public interface ITrackHistoryService:IService<TrackHistory>
    {
    ...
    Task<TrackHistory> GetTrackItem(string caseid, string node, string status);
    }
}