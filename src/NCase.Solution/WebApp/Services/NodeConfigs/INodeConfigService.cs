...
/// Created Date: 3/3/2020 11:26:28 AM
/// Author: neo.zhu
/// Tools: SmartCode MVC5 Scaffolder for Visual Studio 2017
/// Copyright (c) 2012-2018 All Rights Reserved
/// </summary>
    public interface INodeConfigService:IService<NodeConfig>
    {
    ...
    Task<NodeConfig> GetConfig(string node, string status);
    Task<NodeConfig> GetPrevConfig(string node, string status);
  }
}