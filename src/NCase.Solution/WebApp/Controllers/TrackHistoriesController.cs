...
{
/// <summary>
/// File: TrackHistoriesController.cs
/// Purpose:案件管理/案件节点跟踪记录
/// Created Date: 3/4/2020 12:00:46 PM
/// Author: neo.zhu
/// Tools: SmartCode MVC5 Scaffolder for Visual Studio 2017
/// TODO: Registers the type mappings with the Unity container(Mvc.UnityConfig.cs)
/// <![CDATA[
///    container.RegisterType<IRepositoryAsync<TrackHistory>, Repository<TrackHistory>>();
///    container.RegisterType<ITrackHistoryService, TrackHistoryService>();
/// ]]>
    ...
    Created = n.Created.ToString("yyyy-MM-dd HH:mm:ss")
		...
		public async Task<ActionResult> Create(TrackHistory trackHistory)
		{
            ...
            if (ModelState.IsValid)
			{
			    ...
			    //DisplaySuccessMessage("Has update a trackHistory record");
			}
			else {
